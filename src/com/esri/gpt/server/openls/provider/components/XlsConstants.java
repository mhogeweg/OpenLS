...
/**
 * Defines some commonly used XLS constants.
 */
public class XlsConstants {
  ...
  /** ="DetermineRoute" operation name*/
  public static String Operation_Route = "DetermineRouteRequest";

  /** ="GetPortrayMapCapabilities" operation name*/
  public static String Operation_GetPortrayMapCapabilities = "GetPortrayMapCapabilitiesRequest";
  
  /** ="PortrayMap" operation name*/
  public static String Operation_PortrayMap = "PortrayMapRequest";
  
  /** ="GetDomain" operation name*/
  public static String Operation_GetDomain = "GetDomain";
  
  /** ="Directory" operation name*/
  public static String Operation_Directory = "DirectoryRequest";
  
  /** ="Geocode" operation name*/
  public static String Operation_Geocode = "GeocodeRequest";
  
  /** ="ReverseGeocode" operation name*/
  public static String Operation_ReverseGeocode = "ReverseGeocodeRequest";
